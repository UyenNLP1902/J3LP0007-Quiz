...
public class ViewQuizHistoryServlet extends HttpServlet {
    ...
    private final String HISTORY_PAGE = "viewHistory.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session != null) {
                if (email.trim().isEmpty() && subject.equals("All")) {

                } else {
                    HistoryDAO dao = new HistoryDAO();
                    dao.searchHistoryByAdmin(email, subject, currentPage, ROWS_PER_PAGE);

                    int noOfRecords = dao.countRecordsByAdmin(email, subject);
